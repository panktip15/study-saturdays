...
var _SingleStudent = __webpack_require__(57);

var _SingleStudent2 = _interopRequireDefault(_SingleStudent);

var _NewStudentForm = __webpack_require__(58);
...
var Main = function (_Component) {
  ...
  _createClass(Main, [{
    ...
    value: function getStudents() {
      ...
      _store2.default.dispatch((0, _store.gotStudents)());
      // axios
      //   .get('/student')
...
exports.gotStudents = exports.getStudents = undefined;
...
var _reduxDevtoolsExtension = __webpack_require__(65);
...
//action creater
var getStudents = exports.getStudents = function getStudents(students) {
  return {
    type: GET_STUDENTS,
    students: students
  };
...
var gotStudents = exports.gotStudents = function gotStudents() {
  // return dispatch => {
  ...
  return function thunk(dispatch) {
    return _axios2.default.get('/student').then(function (res) {
      return res.data;
...
var store = (0, _redux.createStore)(reducer, (0, _reduxDevtoolsExtension.composeWithDevTools)((0, _redux.applyMiddleware)(_reduxLogger2.default, _reduxThunk2.default)));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(61)(module)))
